...
export declare type CarbonProjectCreateFormInputValues = {
    projectName?: string;
    projectType?: string;
...
export declare type CarbonProjectCreateFormValidationValues = {
...
export declare type CarbonProjectCreateFormOverridesProps = {
    CarbonProjectCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CarbonProjectCreateFormProps = React.PropsWithChildren<{
    overrides?: CarbonProjectCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: CarbonProjectCreateFormInputValues) => CarbonProjectCreateFormInputValues;
    onSuccess?: (fields: CarbonProjectCreateFormInputValues) => void;
    onError?: (fields: CarbonProjectCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CarbonProjectCreateFormInputValues) => CarbonProjectCreateFormInputValues;
    onValidate?: CarbonProjectCreateFormValidationValues;
} & React.CSSProperties>;
export default function CarbonProjectCreateForm(props: CarbonProjectCreateFormProps): React.ReactElement;
